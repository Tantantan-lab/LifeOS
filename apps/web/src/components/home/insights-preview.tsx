...
import type { InsightPreview as Insight } from "@/data/types";
import { Panel } from "@/components/primitives/panel";
import { SectionHeading } from "@/components/primitives/section-heading";
import { SAMPLE_BADGE } from "@/lib/copy";

/**
 * Evidence-based observations, each badged Sample until the AI layer
 * (M6) ships. Facts only — no judgment words, no life philosophy.
 */
